...
const getBuiltinSupportedVersions = async () => {
  ...
  try {
    const filePath = node_url.fileURLToPath(new URL('./supportedVersions.jwt', (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.src || new URL('rootWindow-RAWj-erU.js', document.baseURI).href))));
...
const start = async () => {
  ...
  await setupI18n();
  (await Promise.all([Promise.resolve().then(function () { return require('./renderer-gPeO26lj.js'); }), Promise.resolve().then(function () { return require('./renderer-X7syKibQ.js'); })])).forEach(module => module.default());
...
exports.watch = watch;
//# sourceMappingURL=rootWindow-RAWj-erU.js.map
